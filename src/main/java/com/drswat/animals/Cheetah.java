...
public class Cheetah extends MammalCarnivorous implements Predator {

	public Cheetah(int weight, int lifetime, Sex sex, int height, int lenght, int speed, int quantityOfTeeth) {
